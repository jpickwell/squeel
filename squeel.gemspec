...
Gem::Specification.new do |s|
  ...
  s.description = 'Squeel unlocks the power of Arel in your Rails application'\
                  ' with a handy block-based syntax. You can write subqueries,'\
                  ' access named functions provided by your RDBMS, and more,'\
                  ' all without writing SQL strings. Supporting Rails 3 and 4.'
